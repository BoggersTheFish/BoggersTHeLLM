...
**Verified CPU reference (Apr 2026):** TinyStories with **`--hf-max-chars 1500000`**, `state_dim=128`, 10 epochs — end **`train_CE` ~3.9**, **`val_CE` ~4.8**. Per-epoch CSV and eval JSON (committed): **[runs/meaningful_apr2026/README.md](runs/meaningful_apr2026/README.md)**. Narrative: **[TRAINING_RUN_LOG.md](TRAINING_RUN_LOG.md)**.
